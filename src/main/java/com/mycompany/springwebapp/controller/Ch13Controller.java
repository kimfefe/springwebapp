...
public class Ch13Controller {
	...
	// <Context:property-placeholder ../>가 WebApplicationContext 단위로 사용하기 때문
	...
	public void filedownload1(int bno, HttpServletRequest request, HttpServletResponse response) throws Exception {
		Ch13Board board = boardService.getBoard(bno); //DB에서 가져옴
	...
	@GetMapping("/logout")
	public String logout(Ch13Member member, Model model, HttpSession session) {
