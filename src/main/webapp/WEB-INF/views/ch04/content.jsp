...
<%-- index.jsp의 중앙내용 --%>
<div class="card m-2">
	<div class="card-header">요청 데이터의 유효성 검사</div>
	<div class="card-body">
		<div class="card m-2">
					...
					<div class="input-group">
						...
						<div class="btn-group btn-group-toggle" data-toggle="buttons">
							<label class="btn btn-secondary active"> <input
								type="radio" name="param4"  <c:if test="${ch04Form1.param4}">checked</c:if> value="true"> true
							</label> <label class="btn btn-secondary"> <input type="radio"
								name="param4" <c:if test="${!ch04Form1.param4}">checked</c:if> value="false"> false
							</label>
						</div>
					</div>
					<div class="input-group">
		...
		<div class="card m-2">
			...
			<div class="card-body">
				<form id="form2" name="form2" action="method2" method="post">
					<div class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text">param1</span>
						</div>
					...
					<div class="mt-2">
						<button class="btn btn-info btn-sm" type="submit">POST
							방식 요청</button>
					</div>
				</form>
			</div>
						...
						<form id="form3" method="post" action="join">
							<div class="input-group">
								...
								<input type="text" name="mid" class="form-control"
									value="${Ch04Form3.mid}" autocomplete="username">
								<form:errors path="ch04Form3.mid" cssClass="mid-error text-danger"/>
							...
							<div class="input-group">
								...
								<input type="password" name="mpassword" class="form-control"
									value="${Ch04Form3.mpassword}" autocomplete="current-password">
								<form:errors path="ch04Form3.mpassword" cssClass="mpassword-error text-danger"/>
							</div>
							<div class="input-group">
								<div class="input-group-prepend">
								...
								<input type="text" name="memail" class="form-control"
									value="${Ch04Form3.memail}">
								<form:errors path="ch04Form3.memail" cssClass="memail-error text-danger"/>
							</div>
							<div class="input-group">
								<div class="input-group-prepend">
								...
								<input type="text" name="mtel" class="form-control"
									value="${Ch04Form3.mtel}">
								<form:errors path="ch04Form3.mtel" cssClass="mtel-error text-danger"/>
							</div>
